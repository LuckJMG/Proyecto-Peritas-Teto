...
class UsuarioInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["email", "nombre", "apellido", "rol", "condominioId", "password"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UsuarioInput from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UsuarioInput from a dict"""
        if obj is None:
            return None
