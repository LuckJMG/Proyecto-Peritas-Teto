...
class Anuncio(BaseModel):
    ...
    titulo: Optional[StrictStr] = None
    contenido: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "condominioId", "titulo", "contenido", "activo", "fechaPublicacion", "creadoPor"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of Anuncio from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of Anuncio from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fechaPublicacion": obj.get("fechaPublicacion"),
