...
class AnuncioInput(BaseModel):
    ...
    titulo: StrictStr
    contenido: StrictStr
    __properties: ClassVar[List[str]] = ["condominioId", "titulo", "contenido"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AnuncioInput from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AnuncioInput from a dict"""
        if obj is None:
            return None
