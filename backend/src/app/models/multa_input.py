...
class MultaInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["residenteId", "condominioId", "tipo", "descripcion", "monto"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MultaInput from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of MultaInput from a dict"""
        if obj is None:
            return None
