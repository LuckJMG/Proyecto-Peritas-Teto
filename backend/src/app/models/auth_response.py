...
class AuthResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessToken", "refreshToken", "usuario"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of usuario
        if self.usuario:
            _dict['usuario'] = self.usuario.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "usuario": Usuario.from_dict(obj.get("usuario")) if obj.get("usuario") is not None else None
        })
        return _obj
